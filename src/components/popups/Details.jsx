  ...
  return (
    <>
      {mainTabs.tab1 ? (
        ...
        >
          ...
          <div className="inner-content m-auto">
            <div className="head d-flex w-100">
              ...
              <div className="w-20 bg-brown d-flex">Country Name</div>
              <div className="w-20 bg-brown d-flex">Eidi Points Required</div>
                ...
                <div className="row d-flex w-100" key={i}>
                  ...
                  <div className="d-flex fd-column w-80">
                    <div className="d-flex w-100">
                      ...
                      <div className="box rewards-container d-flex al-start f-wrap jc-center gap-1 w-50">
        ...
        <div
          className="details-popup f-tangoSans p-rel"
          style={{ backgroundImage: `url(${detailsBg2})`, height: "100vw" }}
        >
          <img
            ...
            style={{ top: "6vw" }}
          />
          <div className="inner-content m-auto" style={{ marginTop: "18vw" }}>
            <div className="head d-flex w-100">
              <div className="w-20 bg-brown d-flex">Button Name</div>
